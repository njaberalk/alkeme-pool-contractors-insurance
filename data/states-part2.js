export const statesPart2 = [
  ...
  },
  {
    ...
    metaDescription:
      'Commercial trucking insurance for Nebraska carriers. Protect your operation along I-80 and through the central freight corridor with coverage built for Plains states.',
    heroHeading: 'Nebraska Trucking Insurance',
    heroSubheading:
      'Reliable coverage for carriers serving the heartland and the I-80 transcontinental corridor.',
    overview:
      'Nebraska sits at the crossroads of American freight transportation, with Interstate 80 carrying a massive volume of transcontinental traffic through the state daily. The trucking industry is deeply woven into Nebraska\'s agricultural economy, hauling grain, livestock, and processed food products from the state\'s farms and packing plants to markets nationwide. Carriers based in Nebraska or running regular lanes through the state need insurance programs that address both the high-volume interstate exposure on I-80 and the seasonal agricultural hauling patterns that define much of the local freight market.',
    sections: [
      {
        heading: 'State Requirements',
        content:
  ...
  },
  {
    ...
    metaDescription:
      'Commercial trucking insurance for New Jersey carriers. Coverage for the densest freight market in America along the I-95 corridor and Port Newark operations.',
    heroHeading: 'New Jersey Trucking Insurance',
    heroSubheading:
      'Comprehensive coverage for carriers in the most densely trafficked freight market in the nation.',
    overview:
  ...
  },
  {
    ...
    metaDescription:
      'Commercial trucking insurance for New Mexico carriers. Coverage for I-10 and I-40 corridor operations with cross-border expertise and desert driving protection.',
    heroHeading: 'New Mexico Trucking Insurance',
    heroSubheading:
      'Coverage for carriers navigating the Southwest freight corridors and US-Mexico border crossings.',
    overview:
  ...
  },
  {
    ...
    metaDescription:
      'Commercial trucking insurance for Rhode Island carriers. Coverage for operations in the smallest state with I-95 corridor and port freight protection.',
    heroHeading: 'Rhode Island Trucking Insurance',
    heroSubheading:
      'Coverage for carriers operating in the Ocean State and the southern New England freight market.',
    overview:
