...
const coverageItems = [
  ...
  { label: 'Inland Marine', href: '/coverage/inland-marine/' },
  ...
  { label: 'Installation Floater', href: '/coverage/installation-floater/' },
...
const resourceItems = [
  ...
  { label: 'Pool Contractor Insurance Cost', href: '/resources/pool-contractor-insurance-cost/' },
  { label: 'Pool Contractor Liability Guide', href: '/resources/pool-contractor-liability-guide/' },
  { label: 'Completed Operations Guide', href: '/resources/completed-operations-guide/' },
  { label: 'Insurance Glossary', href: '/resources/pool-contractor-insurance-glossary/' },
  { label: '\u2014 Insights \u2014', href: null, divider: true },
  { label: 'Industry Trends 2026', href: '/blog/pool-industry-trends-2026/' },
  { label: 'Common Insurance Mistakes', href: '/blog/common-insurance-mistakes-pool-contractors/' },
];
...
const industryItems = [
  ...
  { label: 'Water Feature Designers', href: '/industries/water-feature-designers/' },
  { label: 'Pool Equipment Suppliers', href: '/industries/pool-equipment-suppliers/' },
  { label: 'Spa Contractors', href: '/industries/spa-contractors/' },
  { label: 'Pool Demolition', href: '/industries/pool-demolition/' },
  { label: 'Aquatic Facilities', href: '/industries/aquatic-facilities/' },
];
...
export default function Header() {
  ...
  const isHome = pathname === '/pool-contractors' || pathname === '/pool-contractors/' || pathname === '/';
