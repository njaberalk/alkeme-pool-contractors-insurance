    ...
    <section className="bg-blue-dark" style={{ padding: '6rem 0' }}>
      <div ref={ref} className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4 text-center fade-in-view">
        ...
        <blockquote className="text-stone font-light leading-relaxed mb-8" style={{ fontSize: 'clamp(1.25rem, 3vw, 1.6rem)', lineHeight: '1.6' }}>
          Working with this team made it easy to get the right coverage for our pool construction company. They understood our risks, moved quickly, and gave us confidence that our business was properly protected from day one.
        </blockquote>
        <div>
          <div className="text-stone font-bold" style={{ fontSize: '1rem' }}>Mike Ramirez</div>
          <div className="text-cream/70" style={{ fontSize: '0.85rem' }}>Owner, Sunbelt Pool Builders</div>
        </div>
      </div>
    </section>
  );
