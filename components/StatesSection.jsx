    ...
    <section id="states" className="bg-brand" style={{ padding: '7rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-12 fade-in-view">
          ...
          <h2 className="text-stone font-bold leading-[1.3] tracking-tight mb-5" style={{ fontSize: 'clamp(2.2rem, 4vw, 2.6rem)' }}>Pool Contractor Insurance Across All 50 States</h2>
          <p className="text-cream font-light" style={{ lineHeight: '22px' }}>State-specific contractor licensing requirements, pool safety codes, and coverage guidance — wherever your company builds.</p>
        </div>
        ...
        <div className="mt-14 text-center">
          <h3 className="text-stone font-bold mb-6" style={{ fontSize: '1.3rem' }}>Major Pool & Spa Markets</h3>
          <div className="flex flex-wrap justify-center gap-2">
            {cities.map((c) => (
