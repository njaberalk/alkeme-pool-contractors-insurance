          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="space-y-2">
                {['auto-liability', 'physical-damage', 'motor-truck-cargo', 'workers-compensation', 'umbrella-excess'].map(slug => (
            ...
            <div>
              ...
              <div className="space-y-2">
                {['owner-operators', 'small-fleets', 'large-fleets', 'pool-remodeling', 'spa-contractors'].map(slug => (
