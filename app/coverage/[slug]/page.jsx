...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/pool-contractors/coverage/${coverage.slug}/`,
    },
    openGraph: {
      title: coverage.metaTitle,
      description: coverage.metaDescription,
      url: `https://alkemeins.com/pool-contractors/coverage/${coverage.slug}/`,
      type: 'website',
    },
  };
}
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: coverage.title,
      provider: { '@type': 'InsuranceAgency', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com/pool-contractors' },
      description: coverage.metaDescription,
      url: `https://alkemeins.com/pool-contractors/coverage/${coverage.slug}/`,
